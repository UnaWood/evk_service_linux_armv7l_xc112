...
#ifndef ACC_DETECTOR_PEAK_DISTANCE_H_
#define ACC_DETECTOR_PEAK_DISTANCE_H_
...
typedef enum
{
	...
	ACC_DETECTOR_DISTANCE_PEAK_PROFILE_MAX = ACC_DETECTOR_DISTANCE_PEAK_PROFILE_MAXIMIZE_DEPTH_RESOLUTION,
